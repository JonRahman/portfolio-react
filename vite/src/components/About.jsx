...
const About = () => {
  return (
    <div>
      <h1>About page</h1>
      <div className="jumbotron text-center bg-body-tertiary">
        <div className="container-fluid py-3 jumboCopy" id="aboutbox">
          <h2>About Me</h2>
          <p className="lead col-md-12 fs-5">
          ...
          <img
            src="Images/me.jpg"
            alt="Picture of Janyalom Rahman"
